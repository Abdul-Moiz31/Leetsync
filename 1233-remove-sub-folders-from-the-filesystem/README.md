<h2><a href="https://leetcode.com/problems/remove-sub-folders-from-the-filesystem/?envType=problem-list-v2&envId=trie">1233. Remove Sub-Folders from the Filesystem</a></h2><h3>Medium</h3><hr><p>Given a list of folders <code>folder</code>, return <em>the folders after removing all <strong>sub-folders</strong> in those folders</em>. You may return the answer in <strong>any order</strong>.</p>
